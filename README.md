...
mamba env create -f SCINKD3/SCINKD.v3.1.5.environment.yml
mamba activate scinkd3
snakemake --use-conda --rerun-incomplete --nolock --cores 24 -s SCINKD3/SCINKD.v3.1.5.snakefile -np #dry-run
snakemake --use-conda --rerun-incomplete --nolock --cores 24 -s SCINKD3/SCINKD.v3.1.5.snakefile
```
